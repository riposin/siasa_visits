...
INSERT INTO labels(locale_id, label, translation) VALUES('es-MX', 'MSG_VCONFIRMED_BTNQR',		'La visita ya fu&eacute; confirmada, use el bot&oacute;n de abajo para ver el c&oacute;digo QR.');
...
INSERT INTO labels(locale_id, label, translation) VALUES('es-MX', 'MSG_ERRCONFIRM_RELOAD',		'Ocurri&oacute; un error al confirmar la visita. Por favor refresque la p&aacute;gina y vuelva a intentarlo.');
INSERT INTO labels(locale_id, label, translation) VALUES('es-MX', 'MSG_VCONFIRMED',				'La visita ya fu&eacute; confirmada.');
...
INSERT INTO labels(locale_id, label, translation) VALUES('en-US', 'MSG_VCONFIRMED_BTNQR',		'The visit has already been confirmed, use the button below to view the QR code.');
...
INSERT INTO labels(locale_id, label, translation) VALUES('en-US', 'MSG_ERRCONFIRM_RELOAD',		'An error occurred while confirming the visit. Please refresh the page and try again.');
INSERT INTO labels(locale_id, label, translation) VALUES('en-US', 'MSG_VCONFIRMED',				'The visit has already been confirmed.');
